...
export const translations: BaseTextContent = {
    ...
    ConnectWithFileUpload: 'Cargar plantilla de Excel',
    ...
    LinkModalDescriptionExample: 'Después de hacer clic en \'Connect to DEX\', Sage le pedirá que autorice una conexión a DEX.',
    LinkModalDescriptionFreeAgent: 'Después de hacer clic en \'Connect to FreeAgent\', Sage le pedirá que autorice una conexión a FreeAgent.',
    LinkModalDescriptionNetSuite: 'Después de hacer clic en \'Connect to NetSuite\', Sage le pedirá que autorice una conexión a NetSuite.',
    LinkModalDescriptionDynamics365: 'Después de hacer clic en \'Connect to Microsoft Dynamics 365\', Sage le pedirá que autorice una conexión a Dynamics 365.',
    LinkModalDescriptionMYOBBusiness: 'Después de hacer clic en \'MYOB\', Sage le pedirá que autorice una conexión a MYOB Business.',
    LinkModalDescriptionFileUpload: 'Después de hacer clic en \'Cargar\', se le pedirá que seleccione un archivo de plantilla de Excel para cargar.',
    ...
    LinkModalFreeAgentOneWay: 'La información de FreeAgent nunca se modificará de ninguna manera. Este es un flujo de datos unidireccional totalmente seguro.',
    LinkModalNetSuiteOneWay: 'La información de NetSuite nunca se modificará de ninguna manera. Este es un flujo de datos unidireccional totalmente seguro.',
    LinkModalDynamics365OneWay: 'La información de Microsoft Dynamics 365 nunca se modificará de ninguna manera. Este es un flujo de datos unidireccional totalmente seguro.',
    LinkModalMYOBBusinessOneWay: 'La información de MYOB Business nunca se modificará de ninguna manera. Este es un flujo de datos unidireccional totalmente seguro.',
    LinkModalFileUploadOneWay: 'La información de su plantilla de Excel nunca se modificará de ninguna manera. Se trata de un flujo de datos unidireccional y totalmente seguro.',
