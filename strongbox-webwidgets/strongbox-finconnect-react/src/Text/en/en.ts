...
export const translations: BaseTextContent = {
    ...
    ImportingFinancials: 'Initiating financial data collection...',
    Done: 'Done',
    Continue: 'Continue',
    Dismiss: 'Dismiss',
    ...
    ConnectAccountingSystemSummaryError: 'An error occurred communicating with the server, please try again later',
